...
namespace STOCK
{
    public partial class frmXuatNoiBo: Form
    {
        public frmXuatNoiBo()
        {
            InitializeComponent();
        ...
        private void frmXuatNoiBo_Load(object sender, EventArgs e)
        {
            ...
            _visible1();
            cbb_donvixuat.SelectedValue = cbb_Donvi.SelectedValue;
            UpdateTongCongMain();
            xuatThongtin();
        ...
        private void Chungtu_Info(tb_CHUNGTU ct)
        {
            ...
            _tbs = _seq.getItem("XNB@" + DateTime.Today.Year.ToString() + "@" + dvi.KYHIEU);
            if (_tbs == null)
            {
                _tbs = new tb_SYS_SEQUENCE();
                _tbs.SEQNAME = "XNB@" + DateTime.Today.Year.ToString() + "@" + dvi.KYHIEU;
                _tbs.SEQVALUE = 1;
                _seq.add(_tbs);
            }
            if (_them)
            {
                ...
                ct.SCT = _tbs.SEQVALUE.Value.ToString("000000") + @"/" + DateTime.Today.Year.ToString().Substring(2, 2) + @"/XNB/" + dvi.KYHIEU;
            ...
            ct.MADVI2 = cbb_donvinhap.SelectedValue.ToString();
        ...
        private void luuthongtin()
        {
            ...
            if (cbb_donvinhap.SelectedValue == null)
        ...
        {
            cbb_donvinhap.DataSource = _dvi.getAllExcept(cbb_Congty.SelectedValue.ToString(),cbb_Donvi.SelectedValue.ToString());
